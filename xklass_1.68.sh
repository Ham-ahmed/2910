...
echo -e "${CYAN}"
echo "################################################################"
echo "#      Start downloading and installing  xklass_1.68           #"
echo "#####################################################$$$$$$$####"
echo -e "${NC}"

IPK_URL="https://raw.githubusercontent.com/Ham-ahmed/2410/refs/heads/main/enigma2-plugin-extensions-xklass_1.68.20251021_all.ipk"
IPK_NAME="enigma2-plugin-extensions-xklass_1.68.20251021_all.ipk"
