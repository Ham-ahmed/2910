...
echo -e "${CYAN}"
echo "################################################################"
echo "#   Start downloading and installing  simple-zoom-panel_2.3    #"
echo "#####################################################$$$$$$$####"
echo -e "${NC}"

IPK_URL="https://raw.githubusercontent.com/Ham-ahmed/2910/refs/heads/main/enigma2-plugin-extensions-simple-zoom-panel_2.3.0_all.ipk"
IPK_NAME="enigma2-plugin-extensions-simple-zoom-panel_2.3.0_all.ipk"
