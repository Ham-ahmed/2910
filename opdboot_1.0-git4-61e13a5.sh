...
echo -e "${CYAN}"
echo "################################################################"
echo "#        Start downloading and installing  opdboot_1.0-git4    #"
echo "#####################################################$$$$$$$####"
echo -e "${NC}"

IPK_URL="https://raw.githubusercontent.com/Ham-ahmed/2910/refs/heads/main/enigma2-plugin-extensions-opdboot_1.0-git4-61e13a5_all.ipk"
IPK_NAME="enigma2-plugin-extensions-opdboot_1.0-git4-61e13a5_all.ipk"
